...
def history_latest():
    ...
    return render_template('history.html', title="Last 100 Records", history_list=history_list)
...
def history_page():
    ...
    return render_template('history.html', title="Record List", history_list=history_list)
